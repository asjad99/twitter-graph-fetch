...
def get_app_token(app_name):
    ...
    #return 'HzlxMlfbLyPnMFslJ3aW51XpQ', 'ZhuAkiAs19c1tPqmfg1jq9wzd2NKaIw61qaIb9EhzzsrzQkK5e'
...
class TwitterQueues(object):
    ...
    def get_new_friends_handle(self):
        ...
        '''
        #eturn TwitterHandle('asjad_99','friends')
...
class TwitterHandle(object):
    ...
    def __init__(self, user, resource='none'):
        self.user = user #'asjad_99'
        self.resource = resource
        #assuming that tweepy api gets used more often, so save it
        #self.api = perform_tweepy_auth('133430191-o5ouFcL7AZupJo9pAuyPC9gW20gejSkentmsZEBd','YNHEgwKH6fZFO9PUpn2TqeXf0yNxy1vPpGmpSJfsWO8fw')
...
def debug():
    ...
    reply = twitter_auth.users.find_one({'twitter_handle':'asjad_99'})
